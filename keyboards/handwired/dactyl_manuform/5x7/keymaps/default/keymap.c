...
[_QWERTY] = LAYOUT_5x7(
  // left hand
   KC_GRV,    KC_1,    KC_2,    KC_3,   KC_4,   KC_5,   RGB_TOG,
   KC_TAB,    KC_Q,    KC_W,    KC_E,   KC_R,   KC_T,   KC_MUTE,
   LT(1,KC_ESC),   KC_A,    KC_S,    KC_D,   KC_F,   KC_G,   KC_VOLD,
   KC_LSFT,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,
   KC_LCTL,   KC_ESC, KC_LEFT,   KC_RGHT,
                               KC_BSPC, KC_SPC,
                               KC_LALT, KC_END,
                               KC_LGUI, KC_HOME,
        // right hand
                 ...
                 KC_VOLU, KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
